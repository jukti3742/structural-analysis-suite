...
(function() {
  ...
  const CURSORS = {
    ...
    support: "url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='28' height='28' viewBox='0 0 28 28' fill='none'><polygon points='5,1.5 0.5,9.5 9.5,9.5' fill='white' stroke='black' stroke-width='1'/><polygon points='5,3.8 2.5,8.2 7.5,8.2' fill='%23f1c40f'/><path d='M5,5 L5,20 L9,16 L13,23 L15,22 L11,15 L15,15 Z' fill='white' stroke='black' stroke-width='1.5'/></svg>\") 5 5, crosshair",
